...
export const REWRITE_BASELINE_CASES: BaselineCase[] = [
  ...
  { id: "identity-lonely-oceans", class: "IMPROVEMENT", purpose: "Isolation benchmark expected to improve", options: { engine: "ECCENTRIC", preset: "LONELY_OCEANS", size: "STANDARD", players: 8, cityStates: 8, seed: "rewrite-benchmark-lonely-oceans" } },
  { id: "identity-broken-island-chains", class: "IMPROVEMENT", purpose: "Correlated island-arc benchmark expected to improve", options: { engine: "ECCENTRIC", preset: "SHATTERED_ARCHIPELAGO", size: "STANDARD", players: 8, cityStates: 8, seed: "rewrite-benchmark-island-chains" } },
  { id: "identity-great-watersheds", class: "IMPROVEMENT", purpose: "Hierarchical drainage benchmark expected to improve", options: { engine: "ECCENTRIC", preset: "GREAT_WATERSHEDS", size: "STANDARD", players: 8, cityStates: 8, seed: "rewrite-benchmark-watersheds" } },
  { id: "identity-glacial-world", class: "IMPROVEMENT", purpose: "Planetary cold and frontier-value benchmark expected to improve", options: { engine: "PHYSICAL", preset: "ICEHOUSE_EARTH", size: "STANDARD", players: 8, cityStates: 8, seed: "rewrite-benchmark-glacial-world" } },
